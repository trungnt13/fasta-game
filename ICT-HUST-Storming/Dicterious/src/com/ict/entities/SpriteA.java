...
public class SpriteA {
	...
	public SpriteA (ArrayList<? extends TextureRegion> region) {
	...
	public SpriteA (Array<? extends TextureRegion> region) {
		keyFrames = new TextureRegion[region.size];
		for (int i = 0; i < keyFrames.length; i++)
			keyFrames[i] = (TextureRegion)region.get(i);
		setRegion(keyFrames[0]);
	...
	public void setKeyFrames (ArrayList<? extends TextureRegion> keyFrame) {
	...
	public void setKeyFrames (Array<? extends TextureRegion> keyFrame) {
		keyFrames = new TextureRegion[keyFrame.size];
		for (int i = 0; i < keyFrames.length; i++)
			keyFrames[i] = (TextureRegion)keyFrame.get(i);
		setRegion(keyFrames[0]);
