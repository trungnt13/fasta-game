...
public class G3CraftCrossbow extends ScreenAdapter {
	...
	private InputAdapter mInput = new InputAdapter() {
		...
		public boolean touchUp (int screenX, int screenY, int pointer, int button) {
			...
			if (mBack.getBoundingRectangle().contains(pro)) DicteriousGame.Game.setScreen(DicteriousGame.SMapSelect);
			return false;
		};
	};
	...
	@Override
	public void show () {
		mBackground = DicteriousGame.AssetManager.get(I.G3.background, Texture.class);
