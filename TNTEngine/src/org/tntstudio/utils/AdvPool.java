...
abstract public class AdvPool<T> {
	...
	public AdvPool (int initialCapacity) {
		this(initialCapacity, Integer.MAX_VALUE);
	}

	/** @param max The maximum number of free objects to store in this pool. */
	public AdvPool (int initialCapacity, int max) {
	...
	abstract protected T newObject (Object... objects);
	...
	public T obtain (Object... params) {
		return freeObjects.size == 0 ? newObject(params) : freeObjects.pop();
	}
	...
	public void delete (T object) {
		freeObjects.removeValue(object, true);
	}

	public void deleteAll (Array<T> objects) {
		freeObjects.removeAll(objects, true);
	}

	/** Removes all free objects from this pool. */
	public void clear () {
		for (Object o : freeObjects)
